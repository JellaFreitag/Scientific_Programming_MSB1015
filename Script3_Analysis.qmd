...
# load variables of Script 2
load_bundle("data/processed/Script2_Filter.rds")
```
...
Considerations: The reclassification was applied only to better handle the class imbalance.\
