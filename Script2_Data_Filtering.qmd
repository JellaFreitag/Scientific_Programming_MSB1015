...
# load variables of Script 1
load_bundle("data/processed/Script1_Data.rds")
```
...
```{r, eval=TRUE, include=FALSE}
save_bundle("data/processed/Script2_Filter.rds",
            expr_only_filtered_probes = expr_only_filtered_probes,
            classes =  classes,
            classes2 = classes2)
```
